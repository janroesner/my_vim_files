...
hi StatusLineNC   guibg=#cc4455  guifg=white    gui=none ctermbg=4
ctermfg=11
hi VertSplit      guibg=#cc4455  guifg=white    gui=none ctermbg=4
ctermfg=11
...
hi Underlined guibg=bg guifg=#99ccff gui=underline ctermbg=bg ctermfg=9
cterm=underline
